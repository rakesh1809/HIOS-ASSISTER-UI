pipeline {
    ...
    environment {
        ...
        NEXUS_URL = 'http://nexus.hios-mgmt.mp.cmscloud.local'
      ...
      //      agent {
        ...
        stage('Post to Nexus') {
            steps {
                ...
                sh "curl --fail -u ${NEXUS_USER}:${NEXUS_PW} --upload-file ${WORKSPACE}/release/${BUILD_ID}.zip ${NEXUS_URL}/repository/${JOB_NAME}/"
            }
        }
